"""
Django settings for infobeans_41950 project.
...
ROOT_URLCONF = 'infobeans_41950.urls'
...
WSGI_APPLICATION = 'infobeans_41950.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "infobeans_41950 API",
    "DESCRIPTION": "API documentation for infobeans_41950 App",
    "VERSION": "v1",
}
